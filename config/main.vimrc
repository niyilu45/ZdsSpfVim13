...
" Vim UI {
    ...
    set list
    set listchars=tab:>-,trail:.,extends:>,precedes:<,nbsp:+ " ASCII works with every Windows font and 'ambiwidth' setting
...
" Plugins {
    ...
    " neocomplete {
        if count(g:spf13_bundle_groups, 'neocomplete') &&
                    \ !get(g:, 'spf13_legacy_neocomplete_disabled', 0)
            let g:acp_enableAtStartup = 0
    ...
    " Snippets {
        if (count(g:spf13_bundle_groups, 'neocomplcache') ||
                    ...
                    \ !get(g:, 'spf13_snippets_disabled', 0)
    ...
    " vim-airline {
        ...
        if isdirectory(expand("~/.vim/bundle/vim-airline-themes/"))
            ...
            if !exists('g:airline_powerline_fonts')
                " ASCII separators render reliably in classic console, Windows
                " Terminal, Git Bash and gVim without a patched font.
